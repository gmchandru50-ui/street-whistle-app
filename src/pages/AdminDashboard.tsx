        ...
        <div className="grid md:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Today: 89</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">From 892 reviews</p>
            </CardContent>
          </Card>
        </div>
                  ...
                  {activeVendors.map((vendor) => (
                    <div key={vendor.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Rating: {vendor.rating} ⭐ • {vendor.orders} total alerts
                        </p>
                      </div>
                  ...
                  <div className="p-4 border rounded-lg space-y-2">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">From: Priya M. • About: Ravi's Vegetables</p>
                      </div>
                      <Badge>⭐ 5.0</Badge>
                    </div>
                    <p className="text-sm">The vendor is always on time and has fresh produce. Very happy with the service.</p>
                  </div>
                  <div className="p-4 border rounded-lg space-y-2">
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="font-medium">Could improve timing</p>
                        <p className="text-sm text-muted-foreground">From: Amit K. • About: Lakshmi Flowers</p>
                      </div>
                      <Badge variant="secondary">⭐ 3.0</Badge>
                    </div>
                    <p className="text-sm">Quality is good but sometimes arrives later than scheduled time.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
